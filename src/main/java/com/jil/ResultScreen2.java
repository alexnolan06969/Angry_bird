...
public class ResultScreen2 implements Screen {
    ...
    public ResultScreen2(Main game, int score) {
        this.game = game;
        this.score = score;
    ...
    public static int calculateStars(int score) {
        ...
        if (score >= 2100) return 2;
        if (score >= 1100) return 1;
        return 0;
    }
    ...
    public void render(float delta) {
        ...
        batch.draw(new Texture(Gdx.files.internal("Black_Background.png")), 0, 0, viewport.getWorldWidth(), viewport.getWorldHeight());
        batch.end();
        stage.act(delta);
        stage.draw();
    }
