...
public class GameScreen implements Screen {
    ...
    public static class GameState {
        ...
        public int p1_health, p2_health, p3_health;
    }
    ...
    public void deleteSaveGame() {
        ...
        if (saveFile.exists()) {
            ...
            if (deleted) {
                Gdx.app.log("Delete", "Savegame.json deleted successfully.");
            } else {
                Gdx.app.log("Delete", "Failed to delete savegame.json.");
            }
        } else {
            Gdx.app.log("Delete", "No savegame.json found to delete.");
        }
    }
    ...
    public void saveGameState() {
        ...
        Gdx.files.local("savegame.json").writeString(jsonString, false);
    ...
    public GameState loadGameState() {
        ...
        Json json = new Json();
        String jsonString = Gdx.files.local("savegame.json").readString();
...
//                    System.out.println("MotuBird collided with BasePig!");
    ...
    public void render(float delta) {
        ...
        if(currentBirdIndex == 7){
            ResultScreen r = new ResultScreen((Main)game,score);
            game.setScreen(r);
        }
